  ...
  <div>
    <a-card>
      <a-row :gutter="20">
        ...
        <a-col :span="3">
          <a-select v-model="selectionID" placeholder="请选择分类" style="width: 200px" @change="CateChange($event)" ref="ad">
            <a-select-option
        ...
        <a-col :span="1">
          <a-button type="info" @click="showAllArtList()">显示全部</a-button>
        </a-col>
      </a-row>
